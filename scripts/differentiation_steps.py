...
def calculate_derivative(expr, var):
    try:
        expr = expr.subs(sp.Symbol(r'\\theta'), theta)
...
def generate_steps(expr, var, current_depth=0, max_depth=2):
    ...
    if current_depth >= max_depth:
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}({format_latex_expr(expr)}) = {format_latex_expr(derivative)}"
        })
        return steps
    ...
    steps.append({
        ...
        "math": f"\\frac{{d}}{{d{var}}}({expr_latex})"
    })
    step_number += 1
    if expr_type == "power_1" and expr == x:
        steps.append({
            "number": step_number,
            "text": "This is just " + var + ", so the derivative is 1.",
            "math": "\\frac{d}{d"+var+"}("+var+") = 1"
        })
        return steps
        ...
        steps.append({
            "number": step_number,
            "text": "This is a constant with respect to "+var+", so the derivative is 0.",
            "math": f"\\frac{{d}}{{d{var}}}({const_latex}) = 0"
        })
        return steps
    if expr_type == "quotient":
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}\\left(\\frac{{{u_latex}}}{{{v_latex}}}\\right) = \\frac{{{v_latex} \\cdot \\frac{{d}}{{dx}}({u_latex}) - {u_latex} \\cdot \\frac{{d}}{{dx}}({v_latex})}}{{({v_latex})^2}}"
        })
        step_number += 1
        ...
        if current_depth < max_depth - 1:
            ...
            if numerator_steps:
                ...
                steps.append({
                    ...
                    "math": f"\\frac{{d}}{{d{var}}}({u_latex}) = {f_prime_latex}"
                })
                step_number += 1
            steps.append({
                "number": step_number,
                "text": "Now let's find the derivative of the denominator:",
                "math": f"\\frac{{d}}{{d{var}}}({v_latex})"
            })
            step_number += 1
            ...
            if denominator_steps:
                ...
                steps.append({
                    ...
                    "math": f"\\frac{{d}}{{d{var}}}({v_latex}) = {g_prime_latex}"
                })
                step_number += 1
        else:
            steps.append({
                ...
                "math": f"\\frac{{d}}{{d{var}}}({u_latex}) = {f_prime_latex}, \\quad \\frac{{d}}{{d{var}}}({v_latex}) = {g_prime_latex}"
            })
            step_number += 1
        steps.append({
            "number": step_number,
            ...
            "math": f"\\frac{{d}}{{d{var}}}\\left(\\frac{{{u_latex}}}{{{v_latex}}}\\right) = \\frac{{{v_latex} \\cdot ({f_prime_latex}) - {u_latex} \\cdot ({g_prime_latex})}}{{({v_latex})^2}}"
        })
        step_number += 1
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}\\left(\\frac{{{u_latex}}}{{{v_latex}}}\\right) = {final_derivative_latex}"
        })
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}({u_latex} \\cdot {v_latex}) = {u_latex} \\cdot \\frac{{d}}{{d{var}}}({v_latex}) + {v_latex} \\cdot \\frac{{d}}{{d{var}}}({u_latex})"
        })
        step_number += 1
        f_prime = calculate_derivative(u, var)
        g_prime = calculate_derivative(v, var)
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}({u_latex} \\cdot {v_latex}) = {u_latex} \\cdot ({g_prime_latex}) + {v_latex} \\cdot ({f_prime_latex})"
        })
        step_number += 1
        final_derivative = calculate_derivative(expr, var)
        final_derivative_latex = format_latex_expr(final_derivative)
        steps.append({
            "number": step_number,
            "text": "The final derivative is:",
            "math": f"\\frac{{d}}{{d{var}}}({u_latex} \\cdot {v_latex}) = {final_derivative_latex}"
        })
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}({u_latex} {operation} {v_latex}) = \\frac{{d}}{{d{var}}}({u_latex}) {operation} \\frac{{d}}{{d{var}}}({v_latex})"
        })
        step_number += 1
        f_prime = calculate_derivative(u, var)
        g_prime = calculate_derivative(v, var)
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}({u_latex} {operation} {v_latex}) = {f_prime_latex} {operation} {g_prime_latex}"
        })
        step_number += 1
        final_derivative = calculate_derivative(expr, var)
        final_derivative_latex = format_latex_expr(final_derivative)
        steps.append({
            "number": step_number,
            "text": "The final derivative is:",
            "math": f"\\frac{{d}}{{d{var}}}({u_latex} {operation} {v_latex}) = {final_derivative_latex}"
        })
        ...
        if isinstance(expr, sp.Pow):
            ...
            steps.append({
                ...
                "math": f"\\frac{{d}}{{d{var}}}[({base_latex})^{{{exponent}}}] = {exponent} \\cdot ({base_latex})^{{{exponent-1}}} \\cdot \\frac{{d}}{{d{var}}}({base_latex})"
            })
            step_number += 1
            ...
            if current_depth < max_depth - 1:
                steps.append({
                    ...
                    "math": f"\\frac{{d}}{{d{var}}}({base_latex})"
                })
                step_number += 1
                ...
                steps.append({
                    ...
                    "math": f"\\frac{{d}}{{d{var}}}({base_latex}) = {g_prime_latex}"
                })
                step_number += 1
            else:
                steps.append({
            ...
            steps.append({
                ...
                "math": f"\\frac{{d}}{{d{var}}}[({base_latex})^{{{exponent}}}] = {exponent} \\cdot ({base_latex})^{{{exponent-1}}} \\cdot ({g_prime_latex})"
            })
            step_number += 1
            final_derivative = calculate_derivative(expr, var)
            final_derivative_latex = format_latex_expr(final_derivative)
            steps.append({
                "number": step_number,
                "text": "The final derivative is:",
                "math": f"\\frac{{d}}{{d{var}}}[({base_latex})^{{{exponent}}}] = {final_derivative_latex}"
            })
            ...
            steps.append({
                ...
                "math": f"\\frac{{d}}{{d{var}}}\\left({outer_latex}\\right) = f'\\left({inner_latex}\\right) \\cdot \\frac{{d}}{{d{var}}}\\left({inner_latex}\\right)"
            })
            step_number += 1
            ...
            if function_name == "cos":
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of tan(u) is sec^2(u):",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of log(u) is 1/u:",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of sqrt(u) is 1/(2sqrt(u)):",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of ln(u) is 1/u:",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of arctan(u) is \\frac{{1}}{{1+u^{{2}}}}:",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of arcsin(u) is \\frac{{1}}{{\\sqrt{{1-u^{{2}}}}}}:",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
                ...
                steps.append({
                    "number": step_number,
                    "text": f"The derivative of arccos(u) is -\\frac{{1}}{{\\sqrt{{1-u^{{2}}}}}}:",
                    "math": f"f'\\left({inner_latex}\\right) = {outer_derivative}"
                })
            else:
            ...
            steps.append({
                "number": step_number,
                "text": f"The derivative of the inner function is:",
                "math": f"\\frac{{d}}{{d{var}}}\\left({inner_latex}\\right) = {inner_derivative_latex}"
            })
            step_number += 1
            ...
            steps.append({
                ...
                "math": f"\\frac{{d}}{{d{var}}}\\left({outer_latex}\\right) = {final_derivative_latex}"
            })
        else:
            final_derivative = calculate_derivative(expr, var)
            final_derivative_latex = format_latex_expr(final_derivative)
            steps.append({
                "number": step_number,
                "text": "This is a composite function, so we apply the chain rule: \\frac{{d}}{{dx}}[f(g(x))] = f'(g(x)) \\cdot g'(x)",
                "math": f"\\frac{{d}}{{d{var}}}({expr_latex}) = {final_derivative_latex}"
            })
        ...
        if isinstance(expr, sp.Pow):
            ...
            if base.is_Symbol and (base == x or base == y or base == z):
                steps.append({
                    "number": step_number,
                    "text": f"This is a power function of the form {var}^{exponent}, so we'll use the power rule: \\frac{{d}}{{dx}}[x^{{n}}] = n \\cdot x^{{(n-1)}}",
                    "math": f"\\frac{{d}}{{d{var}}}({base_latex}^{{{exponent}}}) = {exponent} \\cdot {base_latex}^{{{exponent-1}}}"
                })
                step_number += 1
                final_derivative = calculate_derivative(expr, var)
                final_derivative_latex = format_latex_expr(final_derivative)
                ...
                steps.append({
                    "number": step_number,
                    "text": f"For this power expression with a non-{var} base, we need a combination of power rule and chain rule:",
                    "math": f"\\frac{{d}}{{d{var}}}({expr_latex}) = {final_derivative_latex}"
                })
        ...
        steps.append({
            "number": step_number,
            "text": f"This is a trigonometric function {outer.func.__name__}({var}). Its derivative follows standard rules: " + rule,
            "math": f"\\frac{{d}}{{d{var}}}\\left({outer_latex}\\right) = \\text{{derivative of}}\\ {outer.func.__name__}({var})\\ \\times\\ \\frac{{d}}{{d{var}}}({inner_latex})"
        })
        step_number += 1
        outer_derivatives = {
            "sin": "cos",
        ...
        steps.append({
            "number": step_number,
            "text": f"The derivative of {outer.func.__name__}({var}) is {outer_derivative_text}.",
            "math": f"\\frac{{d}}{{d{var}}}({outer_latex}) = {outer_derivative_text}({inner_latex}) \\times \\frac{{d}}{{d{var}}}({inner_latex})"
        })
        step_number += 1
        inner_derivative = calculate_derivative(inner, var)
        inner_derivative_latex = format_latex_expr(inner_derivative)
        if current_depth < max_depth - 1:
            ...
            steps.append({
                ...
                "math": f"\\frac{{d}}{{d{var}}}({inner_latex}) = {inner_derivative_latex}"
            })
            step_number += 1
        else:
            steps.append({
        ...
        steps.append({
            ...
            "math": f"\\frac{{d}}{{d{var}}}({outer_latex}) = {final_derivative_latex}"
        })
        ...
        if outer.func.__name__ == "asin":
            rule = "\\frac{{d}}{{dx}}[asin(x)] = \\frac{1}{\\sqrt{1-x^2}}"
        elif outer.func.__name__ == "acos":
            rule = "\\frac{{d}}{{dx}}[acos(x)] = -\\frac{1}{\\sqrt{1-x^2}}"
        elif outer.func.__name__ == "atan":
            rule = "\\frac{{d}}{{dx}}[atan(x)] = \\frac{1}{1+x^2}"
        elif outer.func.__name__ == "acsc":
            rule = "\\frac{{d}}{{dx}}[acsc(x)] = -\\frac{1}{|x|\\sqrt{x^2-1}}"
        elif outer.func.__name__ == "asec":
            rule = "\\frac{{d}}{{dx}}[asec(x)] = \\frac{1}{|x|\\sqrt{x^2-1}}"
        elif outer.func.__name__ == "acot":
            rule = "\\frac{{d}}{{dx}}[acot(x)] = -\\frac{1}{1+x^2}"
        steps.append({
            "number": step_number,
            "text": f"This is an inverse trigonometric function {outer.func.__name__}({var}). We'll differentiate using its standard rule: " + rule,
            "math": f"\\frac{{d}}{{d{var}}}\\left({outer_latex}\\right)"
        })
        step_number += 1
        inverse_trig_derivatives = {
            "asin": "\\frac{1}{\\sqrt{1-^2}}",
            "acos": "-\\frac{1}{\\sqrt{1-x^2}}",
            "atan": "\\frac{1}{1+x^2}",
            "acsc": "-\\frac{1}{|x|\\sqrt{x^2-1}}",
            "asec": "\\frac{1}{|x|\\sqrt{x^2-1}}",
            "acot": "-\\frac{1}{1+x^2}",
        }
        ...
        steps.append({
            "number": step_number,
            "text": f"The derivative of {outer.func.__name__}({var}) is {outer_derivative_text}.",
            "math": f"\\frac{{d}}{{d{var}}}({outer_latex}) = {outer_derivative_text} \\times \\frac{{d}}{{d{var}}}({inner_latex})"
        })
        step_number += 1
        inner_derivative = calculate_derivative(inner, var)
        inner_derivative_latex = format_latex_expr(inner_derivative)
        ...
        steps.append({
            "number": step_number,
            "text": "This is a natural logarithm function ln(x). We'll use the rule: \\frac{{d}}{{dx}}[ln(x)] = \\frac{{1}}{{x}}",
            "math": f"\\frac{{d}}{{d{var}}}\\left({outer_latex}\\right)"
        })
        step_number += 1
        steps.append({
            "number": step_number,
            "text": "The derivative of ln(x) is \\frac{{1}}{{x}}, so we apply the chain rule with the inside function:",
            "math": f"\\frac{{d}}{{d{var}}}({outer_latex}) = \\frac{{1}}{{{inner_latex}}} \\times \\frac{{d}}{{d{var}}}({inner_latex})"
        })
        step_number += 1
        inner_derivative = calculate_derivative(inner, var)
        inner_derivative_latex = format_latex_expr(inner_derivative)
...
if __name__ == '__main__':
    for line in sys.stdin:
        try:
            ...
            # print("Type:", classify_differentiation(simplified))
            ...
            print(json.dumps({"simplified":simplified, "steps":steps, "result": result}), flush=True)
        except Exception as e:
