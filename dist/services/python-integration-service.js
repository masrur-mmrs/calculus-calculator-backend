...
exports.pythonIntegrationService = void 0;
...
class PythonIntegrationService {
    ...
    startPythonProcess() {
        this.process = (0, child_process_1.spawn)('python3', ['./scripts/integration.py']);
...
exports.pythonIntegrationService = new PythonIntegrationService();
